...
namespace TrafficTrain
{
    public partial class ChoicePathArrival : Form
    {
        ...
        public ChoicePathArrival(List<Move.t_train> trains)
        {
            ...
            {
                tablecommand.Rows.Add(new object[] {numbertrain, train.DObjectName, train.TimeEvent, train.TrainNumberString });
                numbertrain++;
            }
            //
        ...
        private void tablecommand_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            //if (e.ColumnIndex != -1 && e.RowIndex != -1)
            //{
            //    SelectNumber = e.RowIndex;
            //    Close();
            //}
        }
